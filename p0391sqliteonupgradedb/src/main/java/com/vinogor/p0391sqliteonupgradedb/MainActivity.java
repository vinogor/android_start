package com.vinogor.p0391sqliteonupgradedb;
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion == 1 && newVersion == 2) {
                ...
                try {
                    ...
                    // в устаревшей таблице добавим новый столбик
                    db.execSQL("alter table people add column posid integer;");

                    // заполним новый столбик
                    for (int i = 0; i < position_id.length; i++) {
                        cv.clear();
                    ...
                    // в SQLite нельзя просто так удалить столбец, ПОЭТОМУ :
                    // создаём временную таблицу, наполняем её из старой, удаляем старую,
                    // создаём заместо старой новую с таким же именем
                    // наполняем новую из промежуточной
                    // удаляем промежуточную
